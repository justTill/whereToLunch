...
class UserLogic:
    ...
    def get_users_that_not_voted_yet(self):
        logger.info('process users that not voted')
    ...
    def get_users_that_do_not_care(self):
        logger.info('process users that do not care and only want to eat')
    ...
    def get_user_that_are_not_available_for_lunch(self):
        logger.info('process users that do not care and are out for lunch')
